...
export type CreateEden<Path extends string, Property extends Record<string, unknown> = {}> = Path extends '' | '/' ? Property : _CreateEden<RemoveStartingSlash<Path>, Property>;
...
type _ComposeElysiaResponse<Schema extends RouteSchema, Handle> = Prettify<(Schema['response'] extends {
    ...
    200: Handle extends AnyElysiaCustomStatusResponse ? Exclude<Handle, AnyElysiaCustomStatusResponse> | Extract<Handle, ElysiaCustomStatusResponse<200, any, 200>>['response'] : Handle extends Generator<infer A, infer B, infer C> ? AsyncGenerator<A, B, C> : Handle extends ReadableStream<infer A> ? AsyncGenerator<A, void, unknown> : Replace<Handle, ElysiaFile, File>;
