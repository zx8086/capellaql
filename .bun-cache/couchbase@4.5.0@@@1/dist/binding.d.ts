...
export interface CppConnection extends CppConnectionAutogen {
    connect(connStr: string, credentials: CppClusterCredentials, dnsOptions: CppDnsConfig | null, appTelemetryOptions: CppAppTelemetryConfig | null, callback: (err: CppError | null) => void): void;
